...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        sentences = [part.strip() for part in self._SENTENCE_BOUNDARY.split(text.strip())]
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # No separator left (or the empty one): cut on raw character positions.
        ...
        if len(parts) == 1:
            # Separator absent from this text: try the next one down the priority list.
