...
class EmbeddingStore:
    ...
    def add_documents(self, docs: list[Document]) -> None:
        ...
        if self._use_chroma and self._collection is not None:
            try:
                ...
                # The in-memory representation remains authoritative for this
                # small educational store even if an optional Chroma backend is
                # unavailable or rejects a metadata value.
                self._use_chroma = False
                self._collection = None
    ...
    def delete_document(self, doc_id: str) -> bool:
        ...
        removed = len(records_to_keep) != len(self._store)
        self._store = records_to_keep
