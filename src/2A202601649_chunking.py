...
class SentenceChunker:
    ...
    ABBREVIATIONS = {
        "Mr.", "Mrs.", "Ms.", "Dr.", "Jr.", "Sr.", "Ths.", "Prof.", "etc.", "e.g.", "i.e."
    }
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        for fragment in sentence_fragments:
            ...
            if not fragment:
                continue
            if sentences and sentences[-1].split()[-1] in self.ABBREVIATIONS:
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        for piece in pieces:
            ...
            if not part:
                continue
            candidate = part if not current_piece else f"{current_piece}{separator}{part}"
            if len(candidate) <= self.chunk_size:
                current_piece = candidate
            else:
                if current_piece:
                    chunks.extend(self._split(current_piece, next_separators))
