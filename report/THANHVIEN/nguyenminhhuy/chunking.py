...
class RecursiveChunker:
    ...
    remaining_separators: list[str],
        ...
        # Base case 1: đoạn hiện tại đã đủ nhỏ.
        if len(current_text) <= self.chunk_size:
            return [current_text]

        # Base case 2: hết separator thì cắt cứng.
        ...
        # Separator rỗng đại diện cho việc cắt theo ký tự.
        if separator == "":
            return [
                current_text[start : start + self.chunk_size]
                for start in range(0, len(current_text), self.chunk_size)
        ...
        # Không tìm thấy separator hiện tại: thử separator tiếp theo.
        if separator not in current_text:
            return self._split(current_text, next_separators)

        raw_parts = current_text.split(separator)

        # Gắn lại separator để hạn chế làm mất cấu trúc văn bản.
        parts = [
