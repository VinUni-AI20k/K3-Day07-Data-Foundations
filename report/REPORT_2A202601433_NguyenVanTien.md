...
> *Ghi chú của nhóm khi tổng hợp:* Phần 4 và Phần 5 là số liệu chạy thật với chiến lược `SentenceChunker(3)` do bạn phụ trách. Phần 1, 2 mô tả theo mã nguồn chung trong `NguyenDuyHaiBang_2A202601225/`; bạn đọc lại và diễn đạt theo cách mình đã làm trước khi nộp.
